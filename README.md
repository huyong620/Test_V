...
| 变量 | 默认值 | 说明 |
| :--- | :--- | :--- |
| `ID` | `ad806487-2d26-4636-98b6-ab85cc8521f7`(`2290c4e2-c1df-4993-88a7-4e2a2137fb44`) | VMess 用户主 ID，用于身份验证，为 UUID 格式 |
| `AID` | `64`,`128` | 为进一步防止被探测所设额外 ID，即 AlterID，范围为 0 至 65535 |
